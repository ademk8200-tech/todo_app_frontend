...
export function WineryCarousel() {
  ...
  return (
    <section
      id="winery"
      ref={sectionRef}
      className="section-padding relative overflow-hidden bg-villa-pattern"
    >
      <div className="container-custom relative">
        {/* Section Header */}
        <div className="fade-up text-center mb-12">
          <div className="section-chip">
            <span className="font-script text-3xl text-gold-400 block -mt-1 leading-none">{wineryCarouselConfig.scriptText}</span>
          </div>
