  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}images/temel-plan.png`} alt="GörevYap Logo" className="w-12 h-12 md:w-14 md:h-14 object-contain transition-transform duration-300 group-hover:scale-110 drop-shadow-[0_0_8px_rgba(234,179,8,0.5)] brightness-110" />
